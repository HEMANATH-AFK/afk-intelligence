  ...
  return (
    <div className="flex h-screen w-screen bg-[#09090b] text-[#e4e4e7] font-sans overflow-hidden select-none antialiased">
      ...
      <motion.div 
        ...
        className="flex flex-col h-full bg-[#0f0f11] border-r border-white/[0.06] shrink-0"
      >
        {/* Workspace Title */}
        <div className="flex items-center justify-between h-14 px-4 border-b border-white/[0.06]">
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            {sidebarExpanded && (
              <span className="text-xs font-semibold tracking-tight text-white/90 truncate">AFK Cognitive Runtime</span>
            )}
          </div>
          {sidebarExpanded && (
            <button 
